...
class FileUploadLAView extends StatefulWidget {
  final UploadMode? initialMode;

  const FileUploadLAView({
    super.key,
    this.initialMode,
  });

  @override
  State<FileUploadLAView> createState() => _FileUploadLAViewState();
}

class _FileUploadLAViewState extends State<FileUploadLAView> {
        ...
        child: Column(
          children: [
            ...
            Container(
              ...
              child: Text(
                uploadMode == UploadMode.fullBody ? '전신 업로드 옆면뷰 모드' : '부위 업로드 옆면뷰 모드',
